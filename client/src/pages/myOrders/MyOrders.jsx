...
<div className="antialiased font-sans bg-gray-200 pt-5">
    <div className="container mx-auto px-4 sm:px-8">
        <div className="py-8">
            <div>
                <h2 className="text-2xl font-semibold leading-tight text-blue-600">Order History</h2>
            </div>
            <div className="my-2 flex sm:flex-row flex-col">
                <div className="flex flex-row mb-1 sm:mb-0">
                    <div className="relative">
                        <select onChange={(e)=>setOrderStatus(e.target.value)} className=" h-full rounded-r border-t sm:rounded-r-none sm:border-r-0 border-r border-b block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border-r focus:bg-white focus:border-gray-500">
                        ...
                        <tbody>
                            {
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-left">
                                    <span
                                        ...
                                        <span className="relative">{order.paymentDetails.paymentStatus}</span>
                                    </span>
                                </td>
                            </tr>
                                ))
